...
import { LayoutDashboard, Search, FileText, IndianRupee, MessageSquare, LogOut, Bell, User, ArrowUpRight } from "lucide-react";
...
export default function FreelancerLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { name: "Browse Projects", href: "/freelancer/browse", icon: Search },
        { name: "My Bids", href: "/freelancer/bids", icon: FileText },
        { name: "My Earnings", href: "/freelancer/earnings", icon: IndianRupee },
            ...
            <Fragment delay={0.1}>
                <aside className="w-64 bg-background border-r border-border hidden md:flex flex-col sticky top-0 h-screen">
                    <div className="p-6">
                        ...
                        <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold mt-1">Freelancer Panel</p>
                    </div>
                    ...
                    <div className="p-4 border-t border-border">
                        <Link href="/freelancer/earnings" className="block mb-4 px-4 py-3 bg-green-500/10 rounded-xl border border-green-500/20 hover:bg-green-500/20 transition-colors group/earnings">
                            <p className="text-xs text-green-700 font-medium flex items-center justify-between">
                                Net Earnings
                                <ArrowUpRight className="w-3 h-3 opacity-0 group-hover/earnings:opacity-100 transition-opacity" />
                            </p>
